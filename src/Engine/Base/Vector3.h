...
public:
    ...
    /**
     * Indicates whether this vector contains nan.
     *
     * @return true if this vector contains nan, false otherwise.
     */
    bool isNaN() const;
    ...
    inline Vector3 lerp(const Vector3& target, float alpha) const;
	...
	/**
	 * division the valua of this vector with the given vector.
	 *
	 * Note: this does not modify this vector.
	 *
	 * @param v The vector to subtract.
	...
	/**
	 * mul the valua of this vector with the given vector.
	 *
	 * Note: this does not modify this vector.
	 *
	 * @param v The vector to subtract.
