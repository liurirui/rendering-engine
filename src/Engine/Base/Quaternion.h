...
public:
	...
	*
	* @param pitch The yaw angle (in radians)
	* @param yaw The pitch angle (in radians)
	* @param roll The roll angle (in radians)
	* @param dst A quaternion to store the result in.
	*/
	static void createFromEuler(float pitch, float yaw, float roll, Quaternion* dst);
	...
	*/
	void computeEuler(float* pitch, float* yaw, float* roll);
	...
	*/
	...
	/**
	 * create RotateQ by dir
	 *
	 *
	 * @param fromDirection The first quaternion.
	 * @param toDirection The second quaternion.
	 * @param dst A quaternion to store the result in.
	 */
	static void fromToRotation(const Vector3& fromDirection, const Vector3& toDirection, Quaternion * dst);
	 ...
	 *
	 * @return True if this Quaternion is equal to the Quaternion vector, false otherwise.
	 */
