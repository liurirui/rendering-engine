...
public:
    ...
    Matrix(float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24,
           float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44, bool autoTranspose = true);

    /**
     * Constructs a matrix whith four Vector4 
     * Be like:
     *     v1.x, v1.y, v1.z, v1.w,
     *     v2.x, v2.y, v2.z, v2.w,
     *     v3.x, v3.y, v3.z, v3.w,
     *     v4.x, v4.y, v4.z, v4.w
     */
    Matrix(Vector4 v1, Vector4 v2, Vector4 v3, Vector4 v4, bool autoTranspose = true);
    ...
    /**
     * Return data pointer if this matrix
     */
    float* data();
	...
	* @param dst A matrix to store the result in.
	*/
	static void createFromEuler(float pitch, float yaw, float roll, Matrix* dst);
	 ...
	 * @param skew The skew.
	 */
	bool decompose(Vector3* scale, Quaternion* rotation, Vector3* translation, Vector3* skew) const;
    ...
    /**
    * Compare this matrix with anothor one.
    *
    * @param m The matrix to compare with.
    * @return The compare result
    */
    bool isEqual (Matrix* m) const;

    /**
     * blend Matrix by given weight.
     *
     * @param dst A matrix to store the result in.
     */
    Matrix blendMatrix(float weight) const;
